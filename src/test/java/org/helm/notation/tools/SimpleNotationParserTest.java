...
public class SimpleNotationParserTest {
  ...
  public void testGetSmiles() throws IOException, NotationException,
    ...
    // assertEquals("Cc1cn([C@@H]2O[C@@]3(COP(O)(=O)O[C@@H]4[C@@H](COP(O)(=O)O[C@@H]5[C@@H](COP(S)(=O)O[C@@H]6[C@@H](COP(O)([*])=O)O[C@H]([C@@H]6O)n6cnc7c(N)ncnc67)O[C@@H]([*])[C@@H]5O)O[C@H]([C@@H]4O)n4cnc5c4nc(N)[nH]c5=O)CO[C@@H]2[C@@H]3O[*])c(=O)nc1N
    // |$;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;_R1;;;;;;;;;;;;;;;;;;_R3;;;;;;;;;;;;;;;;;;;;;;;_R2;;;;;$|",
    // result);

    String result = SimpleNotationParser.getSimplePolymerSMILES(getInlineSmilesModAdenine(), Monomer.NUCLIEC_ACID_POLYMER_TYPE);
...
// assertEquals(
// "C[C@H](NC(=O)[C@H](C)NC(=O)[C@H](CCCCN[*])NC(=O)CNC(=O)CN[*])C(=O)N[C@@H](C[SeH])C([*])=O
// |$;;;;;;;;;;;;;;;;_R3;;;;;;;;;;_R1;;;;;;;;_R2;$|",
// result);
//
// result = SimpleNotationParser.getSimplePolymerSMILES(
...
// assertEquals(result1, result);
  ...
  public void testGetPeptideSequence() throws NotationException,
    ...
    assertEquals("G|G|K|A|A|seC", SimpleNotationParser.getModifiedPeptideSequence(peptide, "|"));
    ...
    assertEquals("G|G|K|A|PM#1|seC", SimpleNotationParser.getModifiedPeptideSequence(peptide, "|"));

    assertEquals("GGKXAC", SimpleNotationParser.getPeptideSequence(getPeptideNotationWithSalt()));

    assertEquals("G|G|K|PM#2|A|seC", SimpleNotationParser.getModifiedPeptideSequence(getPeptideNotationWithSalt(), "|"));
  ...
  public void testGetMonomerIDList() throws NotationException {
    ...
    notation =
        "[C[C@@]1([*])O[C@H](CO[*])[C@@H](O[*])[C@H]1O |$;;_R3;;;;;_R1;;;_R2;;$|](A)P.RP.[C[C@@]1([*])O[C@H](CO[*])[C@@H](O[*])[C@H]1O |$;;_R3;;;;;_R1;;;_R2;;$|](T)P.R([Cc1nc2c(nc(N)[nH]c2=O)n1[*] |$;;;;;;;;;;;;_R1$|])P.R([Cc1cc(N)nc(=O)n1[*] |$;;;;;;;;;_R1$|])";
