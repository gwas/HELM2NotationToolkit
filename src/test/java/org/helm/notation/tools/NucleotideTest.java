...
public class NucleotideTest {
	...
	public void testGetNotation() throws NotationException, IOException,
		...
		AssertJUnit.assertEquals("R(A)P.R(U)P.R(G)P", notation);
	...
	public void testGetNaturalAnalog() throws MonomerException, IOException,
		...
		AssertJUnit.assertEquals("C", n.getNaturalAnalog());
		...
		AssertJUnit.assertEquals("C", baseMonomer.getNaturalAnalog());

		n = new Nucleotide("R(A)P", Nucleotide.MIDDLE_POSITION_TYPE);

		AssertJUnit.assertEquals("A", n.getNaturalAnalog());
		...
		n = new Nucleotide(
				...
				Nucleotide.MIDDLE_POSITION_TYPE);
		AssertJUnit.assertEquals("X", n.getNaturalAnalog());
	...
	public void testGetComplementSequence() throws NotationException,
		...
		AssertJUnit.assertEquals("5'-AAUAUGUCUCCAGAAUGUAGC-3'", normal);
		reverse = NucleotideSequenceParser
				.getReverseComplementSequence(sequence);
		AssertJUnit.assertEquals("3'-CGAUGUAAGACCUCUGUAUAA-5'", reverse);
		...
		normal = NucleotideSequenceParser.getNormalComplementSequence(sequence);
		AssertJUnit.assertEquals("5'-ACCCUAGCU-3'", normal);
		reverse = NucleotideSequenceParser
				.getReverseComplementSequence(sequence);
		AssertJUnit.assertEquals("3'-UCGAUCCCA-5'", reverse);
		notation = NucleotideSequenceParser.getNotation(sequence);
		AssertJUnit.assertEquals("R(A)P.R(G)P.R(C)P.R(U)P.R(A)P.R(G)P.R(G)P.R(G)P.R(U)P",
				notation);
